(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".partners__slider-1")) new swiper_core_Swiper(".partners__slider-1", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 6,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const contentWrapper = document.querySelector("[data-showmore-content]");
        if (!showMoreButton || !contentWrapper) return;
        const items = Array.from(contentWrapper.children);
        ...
        items.forEach(((item, index) => {
            if (index >= visibleCount) {
                ...
                item.style.transition = "opacity 0.5s ease, max-height 0.5s ease";
                item.style.display = "none";
            }
        }));
        if (items.length > visibleCount) showMoreButton.hidden = false;
        showMoreButton.addEventListener("click", (function() {
            ...
            showMoreButton.style.transition = "all 0.3s ease";
